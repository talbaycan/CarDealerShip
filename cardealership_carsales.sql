...
CREATE TABLE `carsales` (
  `carSellId` int(11) NOT NULL AUTO_INCREMENT,
  `carId` int(11) NOT NULL,
  `sellPrice` decimal(10,2) NOT NULL,
  `customerName` varchar(45) NOT NULL,
  `customerAddress` varchar(45) DEFAULT NULL,
  `customerPostCode` varchar(45) DEFAULT NULL,
  `customerCountry` enum('UNITEDKINGDOM','USA','FRANCE') NOT NULL DEFAULT 'UNITEDKINGDOM',
  `customerPhone` varchar(45) NOT NULL,
  `customerEmail` varchar(45) NOT NULL,
  `saleDate` datetime NOT NULL,
  PRIMARY KEY (`carSellId`)
...
-- Dump completed on 2019-10-01 11:37:48
